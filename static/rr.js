...
var ControlBar = function (dashjsMediaPlayer, displayUTCTimeCodes) {
    ...
    var toggleMuteBtnState = function () {
        ...
        if (self.player.isMuted()) {
            span.classList.remove("fa-volume-high");
            span.classList.add("fa-volume-xmark");
        } else {
            span.classList.remove("fa-volume-xmark");
            span.classList.add("fa-volume-high");
        }
    };
    ...
    var onFullScreenChange = function (/*e*/) {
        ...
        if (isFullscreen()) {
            enterFullscreen();
            icon = fullscreenBtn.querySelector(".fullscreen-actions");
    ...
    return {
        ...
        resetSelectionMenus: function () {
            ...
            if (menuHandlersList.caption) {
                ...
                nativeTextTracks.removeEventListener(
                    "change",
                    _onTracksChanged
                );
            }
...
function init() {
    //const url = "https://cdn.z9fr.xyz/videos/rr/manifest.mpd";
    const url = document.querySelector("#video-url").getAttribute("value");
